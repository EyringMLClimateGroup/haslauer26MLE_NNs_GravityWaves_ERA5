# Script to prepare ERA5 data (regridding of variables for ML)
...
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var131 -seldate,${suffix} ${simulation} ${preprocessed}ua_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var132 -seldate,${suffix} ${simulation} ${preprocessed}va_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var135 -seldate,${suffix} ${simulation} ${preprocessed}wa_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var130 -seldate,${suffix} ${simulation} ${preprocessed}ta_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var133 -seldate,${suffix} ${simulation} ${preprocessed}hus_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var129 -seldate,${suffix} ${simulation} ${preprocessed}geop_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var228 -seldate,${suffix} ${simulation2d} ${preprocessed}precip_${timestep}_${hgridres}.grb
cdo -P 12 setmisstonn -remapcon,${hgridres} -selname,var59 -seldate,${suffix} ${simulation2d} ${preprocessed}cape_${timestep}_${hgridres}.grb
